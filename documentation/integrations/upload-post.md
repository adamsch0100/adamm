...
| media\_type | String | No | Type of media ("IMAGE" or "STORIES") | "IMAGE" |
...
| Field | Type | Description |
|-------|------|-------------|
| results.tiktok.publish\_id | String | Unique identifier for the published post |
| results.tiktok.status | String | Publishing status (e.g., "PUBLISH\_COMPLETE") |
...
| usage.last\_reset | String | Timestamp of last usage counter reset |
